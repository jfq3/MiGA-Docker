...
* [Create the MiGA Container](create-container/readme.md)  
    * [Installing Locally](installation/create_local-container.md) 
    * [Installing on a Cluster](installation/cluster-installation.md)  
* [Add a Reference Database](installation/add-a-reference-database.md)
    * [MiGA-Web](installation/miga-web-add-reference-database.md)
    * [MiGA-CLI](installation/cli-add-reference-database.md)
